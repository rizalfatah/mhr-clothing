...
@section('content')
    ...
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-semibold text-gray-800 dark:text-neutral-200">Edit Kategori</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">Perbarui informasi kategori</p>
    </div>
        ...
        <div class="grid lg:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4"
                                    class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 @error('description') border-red-500 @enderror">{{ old('description', $category->description) }}</textarea>
                                @error('description')
                                    <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div
                        ...
                        <div class="p-4 sm:p-7">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm text-gray-600 dark:text-neutral-400">Unggah gambar baru untuk
                                        mengganti gambar ini</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 sm:p-7">
                        <div class="mb-6">
                            <h2 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">
                                {{ $category->image ? 'Ubah Gambar Kategori' : 'Gambar Kategori' }}</h2>
                            <p class="text-sm text-gray-600 dark:text-neutral-400">
                                {{ $category->image ? 'Unggah gambar baru untuk mengganti yang lama' : 'Unggah gambar untuk kategori' }}
                            </p>
                        </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div
                    ...
                    <div class="p-4 sm:p-7">
                        <div class="mb-4">
                            <h2 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Info Kategori</h2>
                        </div>

                        <dl class="space-y-2">
                            <div class="flex justify-between text-sm">
                                <dt class="text-gray-500 dark:text-neutral-400">Jumlah Produk:</dt>
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <dd class="font-medium text-gray-800 dark:text-neutral-200 truncate">
                                    {{ $category->slug }}</dd>
                            </div>
                        </dl>
                    </div>
