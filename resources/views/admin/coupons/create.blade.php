...
@section('breadcrumb', 'Tambah Kupon Baru')
...
@section('content')
    ...
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-semibold text-gray-800 dark:text-neutral-200">Tambah Kupon Baru</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">Buat kupon diskon untuk meningkatkan penjualan</p>
    </div>
