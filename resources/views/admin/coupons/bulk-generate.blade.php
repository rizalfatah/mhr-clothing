...
@section('title', 'Generate Bulk Kupon')
@section('breadcrumb', 'Generate Bulk Kupon')
...
@section('content')
    ...
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-semibold text-gray-800 dark:text-neutral-200">Generate Bulk Kupon</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">Buat banyak kupon sekaligus secara otomatis</p>
    </div>

    <!-- Form -->
    <form action="{{ route('admin.coupons.bulk-store') }}" method="POST">
        @csrf
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div
                    ...
                    <div class="p-4 sm:p-7">
                        <div class="mb-6">
                            <h2 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Pengaturan Generasi</h2>
                            <p class="text-sm text-gray-600 dark:text-neutral-400">Format kode: [Prefix][Acak][Postfix]</p>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="grid sm:grid-cols-3 gap-4">
                                ...
                                <!-- Digit Length -->
                                <div>
                                    <label for="digit_length" class="block text-sm font-medium mb-2 dark:text-white">Panjang
                                        Acak <span class="text-red-500">*</span></label>
                                    <input type="number" id="digit_length" name="digit_length"
                                        value="{{ old('digit_length', 6) }}" min="4" max="12"
                                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 @error('digit_length') border-red-500 @enderror"
                                        required>
                                    @error('digit_length')
                                        <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                    @enderror
                                ...
                                <!-- Postfix -->
                                <div>
                                    <label for="postfix" class="block text-sm font-medium mb-2 dark:text-white">Postfix
                                        (Akhiran)</label>
                                    <input type="text" id="postfix" name="postfix" value="{{ old('postfix') }}"
                                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm uppercase focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 @error('postfix') border-red-500 @enderror"
                                        placeholder="2024">
                                    @error('postfix')
                                        <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                    @enderror
                            ...
                            <!-- Quantity -->
                            <div>
                                <label for="quantity" class="block text-sm font-medium mb-2 dark:text-white">Jumlah Kupon
                                    <span class="text-red-500">*</span></label>
                                <input type="number" id="quantity" name="quantity" value="{{ old('quantity', 10) }}"
                                    min="1" max="1000"
                                    class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 @error('quantity') border-red-500 @enderror"
                                    required>
                                <p class="mt-1 text-xs text-gray-500 dark:text-neutral-500">Maksimal 1000 kupon per
                                    generasi</p>
                                @error('quantity')
                                    <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                ...
                <!-- Coupon Details (Similar to Create) -->
                <div
                    class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-800 dark:border-neutral-700">
                    <div class="p-4 sm:p-7">
                        <div class="mb-6">
                            <h2 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Detail Kupon</h2>
                        </div>
                            ...
                            <div class="grid sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type"
                                        ...
                                        required>
                                        <option value="fixed" {{ old('type') == 'fixed' ? 'selected' : '' }}>Potongan
                                            Tetap (Rp)</option>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 dark:text-neutral-500">Masukkan jumlah Rupiah
                                        atau
                                        persen</p>
                                    @error('value')
                                        <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                ...
                <div
                    ...
                    <div class="p-4 sm:p-7">
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-gray-600 dark:text-neutral-400">Batasi berapa kali setiap kupon dapat
                                digunakan
                            </p>
                        </div>
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="usage_limit_per_user"
                                    class="block text-sm font-medium mb-2 dark:text-white">Batas per User</label>
                                <input type="number" id="usage_limit_per_user" name="usage_limit_per_user"
                                    value="{{ old('usage_limit_per_user', 1) }}" min="1"
