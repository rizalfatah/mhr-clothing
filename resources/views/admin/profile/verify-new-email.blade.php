...
@section('breadcrumb', 'Verify New Email')

@section('content')
    <!-- Page Header -->
    <div class="mb-5">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Change Email Address</h1>
        <p class="text-sm text-gray-600 dark:text-neutral-400">Verify your new email to complete</p>
    </div>
    ...
    <div class="mb-6">
        <div class="flex items-center gap-x-2">
            ...
            <div class="text-sm text-gray-500 dark:text-neutral-400">Verify Current Email</div>
            ...
            <div class="flex items-center justify-center w-8 h-8 rounded-full bg-blue-600 text-white text-sm font-semibold">
                2</div>
            <div class="text-sm font-medium text-gray-800 dark:text-white">Verify New Email</div>
        </div>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-800 dark:border-neutral-700">
        ...
        <div class="p-6">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-green-700 dark:text-green-300">
                            Current email verified! A verification code has been sent to
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700 dark:text-blue-300">
                            This is the final step. Enter the code sent to your new email to complete the change.
            ...
            <form method="POST" action="{{ route('admin.profile.email.verify-new-code') }}">
                @csrf
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('admin.profile.email.resend-new') }}"
