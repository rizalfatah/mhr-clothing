                ...
                <div
                    ...
                    <div class="p-4 sm:p-7">
                        ...
                        <div id="variants-container" class="space-y-4">
                            @php
                                $allSizes = \App\Models\ProductVariant::getAvailableSizes();
                                $existingVariants = $product->variants->keyBy('size');
                            @endphp

                            @foreach ($allSizes as $index => $size)
                                @php
                                    $variant = $existingVariants->get($size);
                                @endphp
                                    ...
                                    <div class="grid sm:grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="variants[{{ $index }}][price_adjustment]"
                                                value="{{ old('variants.' . $index . '.price_adjustment', $variant->price_adjustment ?? 0) }}"
                                    ...
                                    <div class="mt-3">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="variants[{{ $index }}][is_available]"
                                                value="1"
                                                {{ old('variants.' . $index . '.is_available', $variant->is_available ?? true) ? 'checked' : '' }}
