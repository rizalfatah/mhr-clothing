<header class="sticky top-0 z-50 bg-linear-to-r from-white to-gray-300 shadow-sm">
    ...
    <nav class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <!-- Cart -->
                <button id="cart-toggle" class="flex items-center gap-2 text-gray-700 hover:text-gray-900 transition relative">
    ...
    <div id="mobile-menu" class="lg:hidden hidden border-t border-gray-200 bg-white">
        <div class="container mx-auto px-4 py-4 space-y-3">
            <a href="/"
                class="block font-medium transition px-4 py-2 rounded-lg {{ request()->is('/') ? 'bg-gray-50 text-gray-900 shadow-sm' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">Home</a>

            <a href="/collections"
                class="block font-medium transition px-4 py-2 rounded-lg {{ request()->is('collections') ? 'bg-gray-50 text-gray-900 shadow-sm' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">Collections</a>
            <a href="/about"
            ...
            <a href="/contact"
                class="block font-medium transition px-4 py-2 rounded-lg {{ request()->is('contact') ? 'bg-gray-50 text-gray-900 shadow-sm' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">Contact</a>
        </div>
    </div>
</header>
